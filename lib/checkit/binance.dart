...
class _BinancePageState extends State<BinancePage> {
  ...
  Future<void> editBinanceData(TextEditingController urlCtrl,
      TextEditingController prixCtrl,) async {
    await showDialog(
      context: context,
      builder:
          (context) =>
  ...
  Widget buildDonationSection() {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          Image.asset(
            'assets/logos/binancelogo.png',
            // Assure-toi que ce fichier est bien dans assets et déclaré dans pubspec.yaml
            height: 250,
          ),
          SizedBox(height: 12),
          Text(
